  ...
  return (
    <div className="min-h-screen bg-[#0F1419] flex flex-col items-center justify-center relative p-4">
      ...
      <div className="absolute top-8 left-8 z-10 flex flex-col items-center gap-4 w-full md:w-auto md:left-1/2 md:-translate-x-1/2">
        ...
        <div className="px-4 py-1.5 rounded-full border border-[#00D9FF]/20 bg-[#00D9FF]/5 backdrop-blur-md flex items-center gap-2">
          <div className="w-1.5 h-1.5 rounded-full bg-[#00D9FF] animate-pulse" />
          <span className="text-[10px] text-[#00D9FF] font-mono tracking-widest uppercase">Account Recovery</span>
        </div>
      </div>
      ...
      <div className="w-full max-w-md relative z-10 animate-in fade-in zoom-in-95 duration-500">
        <div className="bg-[#0A0F14]/60 backdrop-blur-3xl border border-white/5 rounded-2xl p-10 shadow-[0_8px_32px_rgba(0,0,0,0.4)] relative overflow-hidden group">
          ...
          {!isSubmitted ? (
            <>
              <h1 className="text-3xl font-light text-[#FFFFFF] mb-2 font-sans tracking-tight">
                Reset <span className="font-semibold text-transparent bg-clip-text bg-gradient-to-r from-[#00D9FF] to-[#00FF88]">Password</span>
              </h1>
                ...
                <div className="group/input mb-8">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className={`w-full bg-white/5 border ${error ? 'border-red-500/50 focus:ring-red-500/50 focus:border-red-500/50' : 'border-white/5 focus:border-[#00D9FF]/50 focus:ring-[#00D9FF]/50'} rounded-xl px-4 py-3.5 text-[#FFFFFF] placeholder-white/20 focus:outline-none focus:ring-1 focus:bg-white/10 transition-all duration-300 font-mono text-sm`}
            ...
            <div className="text-center py-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
              ...
              <h2 className="text-2xl font-light text-[#FFFFFF] mb-2 font-sans tracking-tight">
                Email <span className="font-semibold text-[#00FF88]">Sent</span>
              </h2>
              <p className="text-[#808A9D] text-xs leading-relaxed font-mono mt-4 mb-8">
                If an account exists with that email, we've sent instructions to reset your password. Please check your inbox.
              </p>
              <button
                onClick={() => setIsSubmitted(false)}
                className="w-full px-4 py-3 border border-white/10 text-white/50 hover:text-[#FFFFFF] hover:bg-white/5 font-mono text-sm tracking-widest rounded-xl transition-all uppercase"
              >
                Try Another Email
              </button>
            </div>
          ...
          <div className="mt-8 text-center pt-6 border-t border-white/5">
            <Link href="/login" className="inline-flex items-center justify-center gap-2 text-[#808A9D] text-[10px] font-mono uppercase tracking-widest hover:text-white transition-colors group/link">
