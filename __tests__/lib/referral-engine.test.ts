...
describe('Referral Commission Rates', () => {
  ...
  it('level 5 = 1.5%', () => expect(COMMISSION_RATES[5]).toBe(0.015));
  it('level 6 = 1.5%', () => expect(COMMISSION_RATES[6]).toBe(0.015));
  it('level 7 = 1%',   () => expect(COMMISSION_RATES[7]).toBe(0.01));
  it('level 8 = 1%',   () => expect(COMMISSION_RATES[8]).toBe(0.01));
  it('level 9 = 1%',   () => expect(COMMISSION_RATES[9]).toBe(0.01));
  it('level 10 = 1%',  () => expect(COMMISSION_RATES[10]).toBe(0.01));
  it('level 11 = 1%',  () => expect(COMMISSION_RATES[11]).toBe(0.01));
  it('level 12 = 1%',  () => expect(COMMISSION_RATES[12]).toBe(0.01));
  it('level 13 = 1%',  () => expect(COMMISSION_RATES[13]).toBe(0.01));

  it('total of all levels = 30%', () => {
  ...
  it('computes correct commission on $1000 investment', () => {
    ...
    expect(+(1000 * COMMISSION_RATES[5]).toFixed(2)).toBe(15.00);  // L5: $15
    expect(+(1000 * COMMISSION_RATES[6]).toFixed(2)).toBe(15.00);  // L6: $15
    expect(+(1000 * COMMISSION_RATES[7]).toFixed(2)).toBe(10.00);  // L7: $10
    expect(+(1000 * COMMISSION_RATES[13]).toFixed(2)).toBe(10.00); // L13: $10
  });
});
