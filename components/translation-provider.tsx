...
const baseTranslations: Record<Language, Record<string, string>> = {
  en: {
    ...
    referralsStat2Sub: 'Levels 1–5 total',
    ...
    overviewReferralSub: '5-level commission',
  ...
  es: {
    ...
    overviewReferralSub: 'Comisión de 5 niveles',
  ...
  vi: {
    ...
    overviewReferralSub: 'Hoa hồng 5 cấp',
  ...
  th: {
    ...
    overviewReferralSub: 'ค่าคอมมิชชั่น 5 ระดับ',
